    ...
    <section className="section">
      <div className="container">
        ...
        <div className="card" style={{ padding: 16, maxWidth: 600 }}>
          ...
          <label htmlFor="new-user-name" style={{ marginTop: 12 }}>
            Nombre
          </label>
          <input
            id="new-user-name"
          ...
          <label htmlFor="new-user-password" style={{ marginTop: 12 }}>
            Contraseña (opcional)
          </label>
          <input
          ...
          <label htmlFor="new-user-membership-type" style={{ marginTop: 12 }}>
            Tipo de membresía
          </label>
          <select
          ...
          <label htmlFor="new-user-payment-status" style={{ marginTop: 12 }}>
            Estado de pago
          </label>
          <select
