        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          {[
            ...
            <button
              key={tab.id}
              className={
                activeTab === tab.id ? "btn btn-primary" : "btn btn-outline"
              }
            ...
            {events.map(e => (
              ...
              >
                ...
                >
                  <div>
                    <div
                      style={{ fontSize: "0.9em", color: "var(--color-muted)" }}
                    >
                      Fecha
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <div>
                      <strong>${getPriceDisplay(e)}</strong>
                    </div>
                  </div>
                  <div>
                    <div
                    ...
                    <div>
                      <strong>{e.max_students || "Sin límite"}</strong>
                    </div>
                  </div>
                  <div>
                    <div
