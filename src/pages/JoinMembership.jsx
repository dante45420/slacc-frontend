    ...
    <section className="section">
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          >
            Conecta con especialistas en cadera de toda Latinoamérica y accede a
...
function ApplicationForm({ onResult }) {
  ...
  async function send(e) {
    ...
    try {
      ...
      if (!res.ok) {
        onResult(false, "Error al enviar solicitud");
        return;
      }
      onResult(
        true,
  ...
  return (
    <form
      onSubmit={send}
      style={{ background: "#f8f9fa", padding: 24, borderRadius: 12 }}
    >
      <div
        style={{
          display: "grid",
      ...
      >
        <div>
          <label htmlFor="application-name">Nombre Completo *</label>
          <input
            id="application-name"
            value={name}
      ...
      <div style={{ marginBottom: 16 }}>
        <label htmlFor="application-phone">Teléfono</label>
        <input
      ...
      >
        <div>
          <label htmlFor="application-specialization">Especialización *</label>
          <input
        ...
        <div>
          <label htmlFor="application-experience">Años de Experiencia *</label>
          <input
      ...
      <div style={{ marginBottom: 16 }}>
        <label htmlFor="application-motivation">
          Motivación para unirse a SLACC *
        </label>
        <textarea
      ...
      <div style={{ marginBottom: 16 }}>
        <label htmlFor="application-document">Documento (PDF) *</label>
        <input
