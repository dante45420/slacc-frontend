  ...
  return (
    <>
      ...
      <Section variant="default" padding="lg" containerSize="default">
        <Grid columns="1.2fr 0.8fr" gap="var(--spacing-5)" style={{ maxWidth: "900px", margin: "0 auto" }}>
          <Card style={{ padding: "var(--spacing-6)" }}>
            <h2 style={{ marginTop: 0, marginBottom: "var(--spacing-3)" }}>
              Información de Contacto
            </h2>
            <p style={{ color: 'var(--color-muted)', marginBottom: "var(--spacing-4)" }}>
          ...
          <Card style={{ padding: "var(--spacing-6)", background: "var(--color-bg-alt)" }}>
